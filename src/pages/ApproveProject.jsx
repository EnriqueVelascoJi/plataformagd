...
export default function ApproveProject() {
    ...
    const projectPath = `https://backmsn.msnserviciosaereos.com.mx/apiv2/usuariogd/project/${id}`
    ...
    try {
        ...
        const personalInformation = {
                ...
                firstSurname: informationArray.firstsurname,
                secondSurname: informationArray.secondsurname,
                email: informationArray.email,
                domain: informationArray.domain,
                subdomain: informationArray.subdomain,
                area: informationArray.area,
                profile: informationArray.profile
        }
        const context = {
                projectName: informationArray.projectname,
                projectDescription: informationArray.projectdescription,
                projectScopeDescription: informationArray.projectscopedescription,
                projectObjective: informationArray.projectobjective,
                region: informationArray.region,
                informationUse: informationArray.informationuse,
                deliverables: informationArray.deliverables,
                aditionalInformation: informationArray.aditionalinformation,
                startDate: dayjs(informationArray.startdate),
                finalDate: dayjs(informationArray.finaldate)
    ...
    <Box sx={{ flexGrow: 1, padding: 1 }}>
      <Grid container spacing={4}>
        <Grid container size={12} justifyContent={'space-between'} alignItems={'center'}>
            <Grid size={12}>
                <Typography variant='h4' style={styles.title}>Resúmen del proyecto</Typography>
            </Grid>
        ...
        <Grid  container item size={{ xs: 12, md: 12 }}>
                ...
                <Alert severity="info">Información del usuario</Alert>
                </Grid>
                <Grid item size={{md: 4}}>
                <TextField
                fullWidth
                ...
                value={newProject.personalInformation.name}
                ...
                value={newProject.personalInformation.firstSurname}
                onChange={handleChange}
                disabled
                />
                </Grid>
                ...
                value={newProject.personalInformation.secondSurname}
                onChange={handleChange}
                disabled
                />
                </Grid>
                ...
                value={newProject.personalInformation.email}
                onChange={handleChange}
                disabled
                />
                </Grid>
            ...
            <FormControl fullWidth>
                ...
                value={newProject.personalInformation.domain}
                label="Age"
                onChange={handleChange}
                disabled
                >
                ...
                <FormControl fullWidth>
                    ...
                    value={newProject.personalInformation.subdomain}
                    label="Age"
                    onChange={handleChange}
                    disabled
                    >
                ...
                <FormControl fullWidth>
                    ...
                    value={newProject.personalInformation.area}
                    label="Age"
                    onChange={handleChange}
                    disabled
                    >
                    <MenuItem value={0}>Area 1</MenuItem>
                    <MenuItem value={1}>Area 2</MenuItem>
                    <MenuItem value={2}>Area 3</MenuItem>
                    </Select>
                </FormControl>
                </Grid>
                {/* <Grid item size={{md: 4}}>
                <FormControl fullWidth>
                    ...
                    value={newProject.personalInformation.rol}
                    label=""
                    onChange={handleChange}
                    disabled
                    >
                    <MenuItem value={0}>Rol 1</MenuItem>
                    <MenuItem value={1}>Rol 2</MenuItem>
                    <MenuItem value={2}>Rol 3</MenuItem>
                    </Select>
                </FormControl>
                </Grid> */}
                <Grid item size={{md: 4}}>
            <FormControl fullWidth>
                ...
                value={newProject.personalInformation.profile}
                label="Age"
                onChange={handleChange}
                disabled
                >
                <MenuItem value={0}>-- Selecciona un perfil de usuario --</MenuItem>
              {
                ...
                <Grid container item size={{ xs: 12, md: 12 }}>
                <Grid item container size={{md: 12}}>
                <Alert severity="info">Contexto del proyecto</Alert>
                </Grid>
                        <Grid item size={{md: 4}}>
                        <TextField
                        fullWidth
                ...
                <Grid container item size={{ xs: 12, md: 12 }}>
                <Alert severity="info" >Participantes del proyecto</Alert>
                    {
