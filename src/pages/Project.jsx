    ...
    const getProject = async() => {
        ...
        try {
            ...
            const project= {
                ...
                isAccepted: informationArray.isprojectaccepted
            }    
            setNewProject(project)

            const status = informationArray.idstatus
            if(status === 2|| status === 3 || status === 4) {
                setVisibleMode(true)
            } else {
                setVisibleMode(false)
            }
            if(informationArray.rejected) setRejectReason(informationArray.rejected)
        ...
        newProject.isAccepted ? (
            <Snackbar open={open} autoHideDuration={5000} onClose={handleClose} TransitionComponent={SlideTransition}>
                <Alert
                    ...
                    sx={{ width: '100%' }}
                >
                    La Oficina de Gobierno de Datos ha aceptado tu solicitud
                </Alert>
            </Snackbar>
        ) :(
            !newProject.isAccepted && !visibleMode? (
            ...
            <Alert
                ...
                sx={{ width: '70%' }}
            >
                La Oficina de Gobierno de Datos ha rechazado tu solicitud. <Button sx={{textTransform: 'none', cursor: 'pointer', color: 'white'}} onClick={viewReject}>Ver más</Button>
            </Alert>
        </Snackbar>
            ) : (
                <Snackbar open={open}onClose={handleClose} TransitionComponent={SlideTransition}>
                    <Alert
                        ...
                        sx={{ width: '100%' }}
                    >
                        La Oficina de Gobierno de Datos esta revisando tu solicitud
                    </Alert>
                </Snackbar>
            )
